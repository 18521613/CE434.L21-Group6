...
#
# Generated by export_simulation on Fri Apr 02 11:31:43 +07 2021
#
################################################################################
...
'-reset_run' switch to the './Lab2_tb.sh' script.

./Lab2_tb.sh -reset_run
...
./Lab2_tb.sh -noclean_files

For more information on the script, please type './Lab2_tb.sh -help'.
